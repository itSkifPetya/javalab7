...
public class InsertCommand extends Command implements DataCollector {
    ...
    public Response execute(Hashtable<Integer, HumanBeing> collection, String[] args) {
        ...
        HumanBeing humanBeing = HumanBeing.insertHumanBeing(key, name, coordinates, LocalDate.now(), realHero, hasToothpick, impactSpeed, soundtrackName, minutesOfWaiting, weaponType, car, userId);
